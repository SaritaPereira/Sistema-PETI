...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-menu">
            ...
            <li><a href="#"><i class="fas fa-bullseye"></i>Objetivos</a></li>
        </ul>
    </nav>
    <div class="content">
        <h1>Bem-vindo ao Sistema PETI</h1>
        <p>Gerencie os dados da sua organização de forma simples e eficiente.</p>
    </div>
</body>
</html>